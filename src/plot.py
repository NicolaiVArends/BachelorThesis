...
def plot_cummulative_portfolio_returns(returns: pd.DataFrame,
    ...
    """ This function uses raw price data to plot and show portfolio cummulative returns.

    The function will not return anything but will show a plot when running.
...
def plot_efficient_frontier(parameters,
    ...
    The function will not return anything but will show a plot of the efficient frontier when running.
    ...
    :param mpl_style: Matplotlib style of the plot, default is 'default'
    :param title: Title of the commulative plot, default is 'Efficient Frontier'
    """
    mpl.style.use(mpl_style)
